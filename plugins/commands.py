...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**🗣 မိတ်‌ဆွေကြည့်ချင်တဲ့ဇာတ်ကားကို ပို့ပေးဖို့အတွက် <b><a href='https://t.me/Movie_By_KP'>👉🏻 Join Channel 👈🏻 </a> ကို Join ထားဖို့လိုပါတယ်။ Channel လေးကို Join ပြီးရင်  Try Again 👈 Tap me လေးကို နှိပ်ပါ ပြီးရင် start လေးပြန်ပေါ်လာတာကို နှိပ်လိုက်ရင် 👌 ရပါပြီး။ \n\n🙈@KOPAING15 **",
